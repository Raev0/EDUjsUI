...
#define FIRMWARE_URL "https://github.com/MarlinFirmware/Marlin"
  ...
  #define MACHINE_NAME "Elite-robot "
#endif
...
#ifdef DOGLCD
  #define STR_Ae "\304"               // '闂佽壈鎻幏锟�' U8glib
  #define STR_ae "\344"               // '闂佺儵鏅幏锟�'
  #define STR_Oe "\326"               // '闂佽壈鎻幏锟�'
  #define STR_oe STR_Oe               // '闂佸搫顑戦幏锟�'
  #define STR_Ue "\334"               // '闂佽壈鎻幏锟�'
  #define STR_ue STR_Ue               // '闂佹椿浜烽幏锟�'
  #define STR_sz "\337"               // '闂佽壈鎻幏锟�'
  #define STR_h2 "\262"               // '闂佹儳楠忛幏锟�'
  #define STR_h3 "\263"               // '婵＄偠鎻幏锟�'
  #define STR_Deg "\260"              // '闂佸湱灏ㄩ幏锟�'
