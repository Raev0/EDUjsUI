...
extern char w_h_4_check;
extern uint32_t w_h_4_1;
extern uint32_t w_h_4_2;
...
int16_t SdBaseFile::read(void* buf, uint16_t nbyte) {
  ...
  /*  if(POWER_CHECK())
  {
  EEPROM.write(0,curCluster_);
  EEPROM.write(1,curCluster_>>8);
    EEPROM.write(2,curCluster_>>16);
  EEPROM.write(3,curCluster_>>24);
 //   EEPROM.write(4,curCluster_>>32);
  EEPROM.write(4,curPosition_);
  EEPROM.write(5,curPosition_>>8);
    EEPROM.write(6,curPosition_>>16);
  EEPROM.write(7,curPosition_>>24);
  w_d_x_5_16=current_position[Z_AXIS];
  EEPROM.write(8,w_d_x_5_16);
//    EEPROM.write(9,curPosition_>>32);
TEST_SOUND();
  }
    */
  return nbyte;
