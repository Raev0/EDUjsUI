...
void manage_heater()
{
  ...
  for(int e = 0; e < EXTRUDERS; e++) 
  {
    ...
    if(watchmillis[e] && millis() - watchmillis[e] > WATCH_TEMP_PERIOD)
    {
        ...
        {
            setTargetHotend(0, e);
              //zct:LCD_MESSAGEPGM("Heating failed");
            SERIAL_ECHO_START;
      ...
      if(fabs(current_temperature[0] - redundant_temperature) > MAX_REDUNDANT_TEMP_SENSOR_DIFF) {
        ...
        if(IsStopped() == false) {
          ...
          //zct: LCD_ALERTMESSAGEPGM("Err: REDUNDANT TEMP ERROR");
        }
  ...
  switch (*state)
  {
    ...
    case 2: // "Temperature Stable" state
      ...
      else if ( (millis() - *timer) > ((unsigned long) period_seconds) * 1000)
      {
        ...
        //zct: LCD_ALERTMESSAGEPGM("THERMAL RUNAWAY");
...
void max_temp_error(uint8_t e) {
  ...
  if(IsStopped() == false) {
    ...
    //zct: LCD_ALERTMESSAGEPGM("Err: MAXTEMP");
  }
  #ifndef BOGUS_TEMPERATURE_FAILSAFE_OVERRIDE
  Stop();
  #endif
...
void min_temp_error(uint8_t e) {
  ...
  if(IsStopped() == false) {
    ...
    //zct: LCD_ALERTMESSAGEPGM("Err: MINTEMP");
  }
  #ifndef BOGUS_TEMPERATURE_FAILSAFE_OVERRIDE
  Stop();
  #endif
...
void bed_max_temp_error(void) {
  ...
  if(IsStopped() == false) {
    ...
    //zct: LCD_ALERTMESSAGEPGM("Err: MAXTEMP BED");
  }
  #ifndef BOGUS_TEMPERATURE_FAILSAFE_OVERRIDE
  Stop();
  #endif
